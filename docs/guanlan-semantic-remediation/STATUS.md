...
G1 DONE（见 G1-MANIFEST.md）。G2 DONE（见 G2-MANIFEST.md）。G3 DONE（见 G3-MANIFEST.md）。G4 DONE（见 G4-MANIFEST.md）。G5 DONE（见 G5-MANIFEST.md）。G6 DONE（见 G6-MANIFEST.md）。G7 DONE（见 G7-MANIFEST.md）。执行中：G8 Causal Replay。
```
