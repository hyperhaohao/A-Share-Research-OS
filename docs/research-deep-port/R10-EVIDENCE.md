...
图谱节点：{"experience_card": 36, "thesis": 15, "report_version": 22, "report": 22, "research_run": 21, "industry_narrative": 1, "industry_driver": 1, "strategy_version": 12, "screening_run": 16, "prediction": 4}
图谱边：134
...
- PASS · 2 研究管线完成 · status=completed run=run_d72fccad948b
- PASS · 3a 证据层（真实采集） · 744 条证据
- PASS · 3b Claims（带引用） · 2396 条；样例引用=['ev_b95223fd5d8f0186b3e03ec8', 'ev_6b68c2330b02423285d0313b', 'ev_6cfd59818cf39cb888250c8e', 'ev_8100d41670
- PASS · 3c Current Thesis（append-only） · 191 条；title=中国稀土 研究综合论点
...
- PASS · 7a Thesis Diff 影响分析 · new_evidence=20 affected_claims=2396 affected_theses=191 action=delta_research
- PASS · 7b Thesis Diff apply（append-only 新版本） · new=ths_71894754f3534020 old=ths_790e883ec8b9472f 保留=True
- PASS · 8 Research Product（类型化报告 Artifact） · title=中国稀土 · 事件调查
- PASS · 9 Research Inbox（§14.1 聚合） · new_ev=8 alerts=0 requests=8 failed=7
- PASS · 10a 原→炼（报告→经验卡） · card=exp_862e30976069
...
- PASS · 11a Experience→Memory candidate · memory=mem_e39eac43bbef
...
- PASS · 14 报告渲染（markdown） · 27210 chars